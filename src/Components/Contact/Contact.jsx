    ...
    <footer id="contact" className={styles.container}>
      ...
      <ul className={styles.links}>
        <li className={styles.link}>
          <img src={getImageUrl("/images/contact/emailIcon.png")} alt="Email icon" />
          <a href="mailto:hassanfaqeed12@gmail.com">hassanfaqeed12@gmail.com</a>
        </li>
        <li className={styles.link}>
          <img
            src={getImageUrl("/images/contact/linkedinIcon.png")}
            alt="LinkedIn icon"
          />
          <a href="https://www.linkedin.com/in/faqeed-hassan-61004a25a">linkedin.com/faqeed-hassan</a>
        </li>
        <li className={styles.link}>
          <img src={getImageUrl("/images/contact/githubIcon.png")} alt="Github icon" />
